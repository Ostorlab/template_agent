...
Welcome to ``template_agent`` contributor's guide.
...
If you experience bugs or general issues with ``template_agent``, please have a look
...
You can help improve ``template_agent`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``template_agent`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``template_agent``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n template_agent python=3 six virtualenv pytest pytest-cov
    conda activate template_agent
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/template_agent.git
    cd template_agent
...
#. Install |pre-commit|_::
   ...
   ``template_agent`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/template_agent
.. _issue tracker: https://github.com/<USERNAME>/template_agent/issues
.. <-- end -->
